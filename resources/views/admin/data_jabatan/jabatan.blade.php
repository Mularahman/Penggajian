...
<div class="container-fluid py-1 px-3">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Data Jabatan</li>
        </ol>
        <h6 class="font-weight-bolder text-white mb-0">Data Jabatan</h6>
    </nav>
        ...
        <div class="card mb-4">
            <div class="card-header pb-0">
                <div class="row">
                    ...
                    <div class="col">
                        <form action="/data_jabatan" method="get">
                            <div class="input-group">
                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nama Jabatan
                                </th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="text-xs font-weight-bold mb-0">{{$item->nama_jabatan}}</p>
  ...
  <div class="modal-body">
    ...
    @csrf
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control "  name="nama_jabatan" placeholder="Enter Nama Jabatan" aria-label="Example text with button addon" aria-describedby="button-addon1">
