    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header">
                ...
                <div class="row">
                    <div class="col-6">
                        <p for="example-month-input" class=" text-uppercase text-secondary  font-weight-bolder opacity-30">Filter Data Absensi Pegawai</p>
                    </div>
                    <div class="col">
                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p class="font-weight-bold mb-0">{{$item->user->nik}}</p>
